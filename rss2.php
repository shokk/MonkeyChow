...
while($row = mysql_fetch_array($result)) {
	$moredata = array();
	$desc = RSSWriter::deTag($row['content']);
	if ( $desc && isset($_REQUEST['crop']) ) {
		$desc = crop($desc, intval($_REQUEST['crop']));
	}
	$moredata['feed_description'] = $desc;	
